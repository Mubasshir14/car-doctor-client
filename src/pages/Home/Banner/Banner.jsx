...
const Banner = () => {
    return (
        <div className="carousel w-full mt-8 rounded-xl mb-8 h-[600px]">
            <div id="slide1" className="carousel-item relative w-full">
                <img src={img1} className="w-full rounded-xl" />
                <div className="absolute flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
                    <div className='text-white space-y-8 w-1/2 ml-12  '>
                        <h2 className='text-6xl font-bold'>Affordable Price For Car Servicing</h2>
                        <p>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
                        <div className=''>
                        <button className="btn mr-4 text-white border-0 bg-[#FF3811]">Diacover More</button>
                        <button className="btn bg-transparent border-white text-white btn-secondary hover:bg-[#FF3811]">Latest Project</button>
                    </div>
                    </div>
